...
const Home = (props) => {
  ...
  return (
    ...
    <div className="my-3 p-3 bg-body bg-light rounded shadow-sm">
      <h6 className="purple-color border-bottom pb-2 mb-0">Recent updates</h6>
      <form id="post-form">
      ...
      <div className="d-flex text-muted pt-3">
        <img className="postimg" src="{{post.User.image}}" width="32" height="32" />
        <p className="pb-3 mb-0 small lh-sm border-bottom">
          <strong className="d-block text-gray-dark">Did you hear that
            <a
       ...
       Content
          ...
          <div className="d-flex text-muted pt-3">
            <p
              ...
              <strong className="d-block text-gray-dark">And then
                <a
                  className="purple-color"
      ...
      <button
        className="btn-comment btn-secondary"
      >comment</button>
